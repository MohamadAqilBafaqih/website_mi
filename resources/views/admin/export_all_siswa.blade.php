    ...
    <style>
        ...
        @media print {
            ...
            .page-number:after {
                ...
                /* Kalau browser support bisa pakai ini:
...
<body>
    ...
    <div class="info-bar d-flex flex-wrap gap-4">
        <div class="info-item">
            @php
        ...
        <div class="info-item">
            <strong>Total:</strong> {{ $siswa->count() }} orang
        </div>

        <div class="info-item">
            <strong>Laki-laki:</strong> {{ $jumlahLaki }} orang
        </div>

        <div class="info-item">
            <strong>Perempuan:</strong> {{ $jumlahPerempuan }} orang
        </div>
    </div>
    ...
    <!-- Nomor halaman (otomatis saat print) -->
