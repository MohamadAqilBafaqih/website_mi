        ...
        <div class="page-header mb-4"
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="mb-0">Atur dan kelola semua pengumuman sekolah</p>
                </div>
            </div>
        ...
        <div class="row animate-fade-in">
            <div class="col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form
                            action="{{ $data->isEmpty() ? route('admin.pengumuman.store') : route('admin.pengumuman.update', $data->first()->id) }}"
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="running_teks" id="running_teks" rows="3" class="form-control border-success"
                                    placeholder="Masukkan running teks" required>{{ $data->isEmpty() ? old('running_teks') : $data->first()->running_teks }}</textarea>
                                @error('running_teks')
                            ...
                            @for ($i = 1; $i <= 3; $i++)
                                <div class="mb-4">
                                    ...
                                    <input type="file" name="foto_slide{{ $i }}"
                                        id="foto_slide{{ $i }}" class="form-control border-success"
                                        accept="image/*">
                                    @error('foto_slide' . $i)
                                        <div class="text-danger small mt-2">
                                            <i class="fas fa-exclamation-circle me-1"></i> {{ $message }}
                                    ...
                                    @if ($data->isNotEmpty() && $data->first()->{'foto_slide' . $i})
                                        <div class="mt-2">
                                            <img src="{{ asset('uploads/pengumuman/' . $data->first()->{'foto_slide' . $i}) }}"
                                                alt="Foto Slide {{ $i }}" width="150" class="img-thumbnail">
