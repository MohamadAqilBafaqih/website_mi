            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1 class="page-title" style="color: #ffffff; font-weight: 700;">
                        <i class="fas fa-comment-dots me-2"></i> Kelola Kritik & Saran
                    </h1>
                    <p class="mb-0">Atur dan kelola semua kritik & saran dari siswa dan orang tua</p>
                </div>
            </div>
                                ...
                                <tbody>
                                    @forelse($data as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <span
                                                    class="badge bg-{{ $item->status == 'Ditindaklanjuti' ? 'success' : ($item->status == 'Dibaca' ? 'warning' : 'danger') }}">
                                                    {{ $item->status }}
                                                </span>
                                            </td>
                                            <td>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bg-success text-white">
                    <h5 class="modal-title" id="detailModalLabel"><i class="fas fa-info-circle me-2"></i>Detail Kritik &
                        Saran</h5>
