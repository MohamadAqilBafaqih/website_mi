            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1 class="page-title" style="color: #ffffff; font-weight: 700;">
                        <i class="fas fa-images me-2"></i> Kelola Galeri Kegiatan
                    </h1>
                    <p class="mb-0">Atur dan kelola semua galeri kegiatan sekolah</p>
                </div>
            </div>
        ...
        <div class="row animate-fade-in">
            <div class="col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form
                            action="{{ empty($galeri) ? route('admin.galerikegiatan.store') : route('admin.galerikegiatan.update', $galeri->id) }}"
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="judul_kegiatan" id="judul_kegiatan"
                                    class="form-control border-success" placeholder="Masukkan judul kegiatan"
                                    value="{{ empty($galeri) ? old('judul_kegiatan') : $galeri->judul_kegiatan }}" required>
                                            ...
                                            <td>
                                                @if ($item->foto)
                                                    <img src="{{ asset('uploads/galeri_kegiatan/' . $item->foto) }}"
                                                        alt="Foto Kegiatan" width="80" class="img-thumbnail">
                                                @else
                                                    -
                                                @endif
                                            </td>
