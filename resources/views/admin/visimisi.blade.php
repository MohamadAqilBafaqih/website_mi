            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1 class="page-title" style="color: #ffffff; font-weight: 700;">
                        <i class="fas fa-bullseye me-2"></i> Kelola Visi & Misi Madrasah
                    </h1>
                    <p class="mb-0">Atur dan kelola informasi visi dan misi madrasah</p>
                </div>
            </div>
        ...
        <div class="row animate-fade-in">
            <div class="col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form
                            action="{{ $data->isEmpty() ? route('admin.visimisi.store') : route('admin.visimisi.update', $data->first()->id) }}"
                            method="POST">
                            @csrf
                            @if ($data->isNotEmpty())
                                @method('PUT')
