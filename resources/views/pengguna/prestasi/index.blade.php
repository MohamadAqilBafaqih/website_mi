                    ...
                    <div class="col-md-4 animate-fade" data-delay="{{ $loop->index * 50 }}">
                        <div class="card h-100 shadow-lg border-0">
                            ...
                            <div class="card-body d-flex flex-column">
                                ...
                                <a href="{{ route('pengguna.prestasi.show', $prestasi->id) }}" class="btn btn-navy mt-auto">
                                    Lihat Detail
                                </a>
                            </div>
                        </div>
                ...
                @empty
                    <div class="col-12">
                        <div class="card shadow-lg border-0 p-5 text-center animate-fade">
                            ...
                            <p class="text-muted mb-0" style="font-size: 1rem;">Informasi prestasi sedang dalam proses pengumpulan</p>
                        </div>
                    </div>
                @endforelse
            </div>
