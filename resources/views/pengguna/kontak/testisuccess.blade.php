        ...
        <div class="col-lg-8">
            ...
            <div class="card shadow-lg rounded-4 border-0 animate-fade">
                <div class="card-body text-center p-5">
                    ...
                    <!-- Judul -->
                    <h3 class="text-navy fw-bold mb-3">Terima Kasih atas Testimoni Anda!</h3>
                    <p class="lead text-muted mb-4">
                        Ucapan dan masukan Anda sangat berarti bagi <strong>MI Diponegoro 03 Karangklesem</strong>.  
                        Testimoni Anda telah berhasil dikirim dan akan kami tampilkan di website kami.
                    </p>

                    <!-- Informasi Status -->
                    <div class="info-box bg-light-navy p-4 rounded-3 mb-4 text-start">
                        <h5 class="text-navy fw-semibold mb-3">
                            <i class="fas fa-info-circle me-2"></i> Informasi Testimoni
                        </h5>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <div class="d-flex">
                                    ...
                                    <div>
                                        <small class="fw-semibold">Status Testimoni</small>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="d-flex">
                                    ...
                                    <div>
                                        <small class="fw-semibold">Tampilan di Website</small>
                                        <p class="mb-0">Akan muncul setelah diverifikasi</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="d-flex justify-content-center gap-3">
                        ...
                        <a href="{{ route('pengguna.testimoni.create') }}" class="btn btn-outline-navy rounded-pill px-4">
                            <i class="fas fa-plus me-2"></i> Beri Testimoni Lagi
                        </a>
                    </div>
                </div>
            </div>
