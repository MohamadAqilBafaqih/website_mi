        ...
        <div class="col-lg-8">
            ...
            <div class="card shadow-lg rounded-4 border-0 animate-fade">
                <div class="card-body text-center p-5">
                    ...
                    <!-- Judul -->
                    <h3 class="text-navy fw-bold mb-3">Pendaftaran Berhasil Dikirim!</h3>
                    <p class="lead text-muted mb-4">
                        Terima kasih telah mendaftar di <strong>MI Diponegoro 03 Karangklesem</strong>.  
                        Data Anda sudah kami simpan dan sedang diproses.  
                    </p>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <div class="d-flex">
                                    ...
                                    <div>
                                        <small class="fw-semibold">Status Pendaftaran</small>
                                        <p class="mb-0">Terkirim dan sedang diproses</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="d-flex">
                                    ...
                                    <div>
                                        <small class="fw-semibold">Konfirmasi Email</small>
                                        <p class="mb-0">Akan dikirim dalam 1x24 jam</p>
                                    </div>
                                </div>
                            </div>
                        </div>
