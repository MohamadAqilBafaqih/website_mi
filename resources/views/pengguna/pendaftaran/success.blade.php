...
<div class="container py-5">
    <div class="row justify-content-center">
        <div class="col-lg-8">
            ...
            <!-- Card Status -->
            <div class="card shadow-lg rounded-4 border-0 animate-fade card-custom">
                <div class="card-body text-center">

                    <!-- Icon -->
                    <div class="mb-4">
                        <div class="status-icon bg-success text-white rounded-circle d-inline-flex align-items-center justify-content-center shadow pulse-icon">
                    ...
                    @if (!empty($link))
                    <div class="alert alert-success mt-3 rounded-4 shadow-lg p-4 text-center border-0 alert-custom">
                        <div class="mb-3">
                        ...
                        <p class="mb-4">
                            ...
                            jadwal kegiatan, dan pengumuman penting, Anda diwajibkan bergabung ke grup WhatsApp resmi calon siswa.
                        </p>
                        <a href="{{ $link }}" target="_blank" class="btn btn-light text-success rounded-pill px-4 fw-semibold shadow-sm pulse-btn">
...
<style>
    ...
    .card-custom {
        ...
        height: auto;
        min-height: unset;
        max-width: 600px; /* card tidak terlalu lebar */
        margin: 0 auto 40px auto; /* jarak bawah agar tidak menabrak footer */
        padding: 30px; /* lebih compact */
    }
    .card-custom:hover {
    ...
    .animate-title { animation: fadeInUp 1s ease-out; }
    .pulse-btn { position: relative; overflow: hidden; animation: pulse 1.5s infinite; }
