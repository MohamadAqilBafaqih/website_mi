...
<div class="page-wrapper">
    ...
    <head>
        ...
        <style>
            ...
            /* Saat di-scroll — warna tetap sama, hanya tambah bayangan */
            .navbar.scrolled {
                background: linear-gradient(135deg, var(--dark-color), var(--primary-color));
                box-shadow: 0 4px 15px rgba(4, 170, 43, 0.2);
            }
            ...
            /* Active — saat diklik / halaman aktif */
            .nav-link.active {
                font-weight: 600;
                background: rgba(212, 255, 0, 0.35);
                /* lebih terang */
            ...
            /* Efek klik agar tidak gelap */
            .nav-link.active {
                font-weight: 600;
                background: rgba(212, 255, 0, 0.35);
                ;
                /* kuning emas transparan */
                color: #e8e5e5 !important;
                box-shadow: 0 0 8px rgba(212, 255, 0, 0.35);
                ;
                transform: translateY(-1px);
            }
        ...
        html {
            ...
            .page-wrapper {
                ...
                display: flex;
                flex-direction: column;
                /* susun header, main, footer vertikal */
            }

            main.flex-fill {
                flex: 1;
                /* isi utama fleksibel dorong footer */
            }
            ...
            /* Samakan warna navbar + offcanvas */
            .navbar,
            .offcanvas {
            ...
            @media (max-width: 991px) {
                ...
                /* 🌿 Warna latar belakang offcanvas dengan gradasi hijau */
                .offcanvas.offcanvas-start {
                    background: linear-gradient(135deg, #027030, #003617);
                    /* hijau muda ke hijau tua */
                    color: #fff;
                }
            ...
            /* 🌿 Dropdown menu background putih */
            .dropdown-menu {
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark sticky-top">
            <div class="container">
                ...
                <div class="offcanvas offcanvas-start text-white" tabindex="-1" id="navbarNav">
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav ms-auto">
                            <li class="nav-item">
                                <a class="nav-link {{ Request::routeIs('pengguna.beranda-content') ? 'active' : '' }}"
                                    href="{{ route('pengguna.beranda-content') }}">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle {{ Request::routeIs('pengguna.visimisi', 'pengguna.sejarah', 'pengguna.dataguru', 'pengguna.prestasi.index', 'pengguna.saranaprasarana') ? 'active' : '' }}"
                                    href="#" id="profilDropdown" role="button" data-bs-toggle="dropdown"
                                    aria-expanded="false">
                                    <i class="fas fa-info-circle me-1"></i> Profil
                                </a>
                                <ul class="dropdown-menu" aria-labelledby="profilDropdown">
                                    <li><a class="dropdown-item {{ Request::routeIs('pengguna.visimisi') ? 'active' : '' }}"
                                            href="{{ route('pengguna.visimisi') }}"><i
                                                class="fas fa-bullseye me-2"></i>Visi & Misi</a></li>
                                    <li><a class="dropdown-item {{ Request::routeIs('pengguna.sejarah') ? 'active' : '' }}"
                                            href="{{ route('pengguna.sejarah') }}"><i
                                                class="fas fa-history me-2"></i>Sejarah Madrasah</a></li>
                                    <li><a class="dropdown-item {{ Request::routeIs('pengguna.dataguru') ? 'active' : '' }}"
                                            href="{{ route('pengguna.dataguru') }}"><i
                                                class="fas fa-chalkboard-teacher me-2"></i>Data Guru</a></li>
                                    <li><a class="dropdown-item {{ Request::routeIs('pengguna.prestasi.index') ? 'active' : '' }}"
                                            href="{{ route('pengguna.prestasi.index') }}"><i
                                                class="fas fa-trophy me-2"></i>Prestasi Siswa</a></li>
                                    <li><a class="dropdown-item {{ Request::routeIs('pengguna.saranaprasarana') ? 'active' : '' }}"
                                            href="{{ route('pengguna.saranaprasarana') }}"><i
                                                class="fas fa-building me-2"></i>Sarana Prasarana</a></li>
                                </ul>
                            </li>

                            <!-- PPDB -->
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle {{ Request::routeIs('ppdb.*') ? 'active' : '' }}"
                                    href="#" id="ppdbDropdown" role="button" data-bs-toggle="dropdown"
                                    aria-expanded="false">
                                    <i class="fas fa-user-graduate me-1"></i> PPDB
                                </a>
                                <ul class="dropdown-menu" aria-labelledby="ppdbDropdown">
                                    <li><a class="dropdown-item {{ Request::routeIs('ppdb.jadwal') ? 'active' : '' }}"
                                            href="{{ route('ppdb.jadwal') }}"><i
                                                class="fas fa-calendar-alt me-2"></i>Jadwal Pendaftaran</a></li>
                                    <li><a class="dropdown-item {{ Request::routeIs('ppdb.syarat') ? 'active' : '' }}"
                                            href="{{ route('ppdb.syarat') }}"><i
                                                class="fas fa-file-alt me-2"></i>Persyaratan</a></li>
                                    <li><a class="dropdown-item {{ Request::routeIs('ppdb.biaya') ? 'active' : '' }}"
                                            href="{{ route('ppdb.biaya') }}"><i
                                                class="fas fa-money-bill-wave me-2"></i>Biaya Pendidikan</a></li>
                                    <li><a class="dropdown-item {{ Request::routeIs('ppdb.kalender') ? 'active' : '' }}"
                                            href="{{ route('ppdb.kalender') }}"><i
                                                class="fas fa-calendar me-2"></i>Kalender Akademik</a></li>
                                </ul>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link {{ Request::routeIs('pengguna.pendidikan') ? 'active' : '' }}"
                                    href="{{ route('pengguna.pendidikan') }}">
                                    <i class="fas fa-graduation-cap me-1"></i> Pendidikan
                                </a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link {{ Request::routeIs('pengguna.berita.index') ? 'active' : '' }}"
                                    href="{{ route('pengguna.berita.index') }}">
                                    <i class="fas fa-newspaper me-1"></i> Berita
                                </a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link {{ Request::routeIs('pengguna.galeri.index') ? 'active' : '' }}"
                                    href="{{ route('pengguna.galeri.index') }}">
                            ...
                            <!-- KONTAK -->
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle {{ Request::routeIs('pengguna.kontak.*', 'pengguna.saranmasukan.index') ? 'active' : '' }}"
                                    href="#" id="navbarKontak" role="button" data-bs-toggle="dropdown"
                                    aria-expanded="false">
                                    <i class="fas fa-envelope me-1"></i> Kontak
                                </a>
                                <ul class="dropdown-menu" aria-labelledby="navbarKontak">
                                    <li><a class="dropdown-item {{ Request::routeIs('pengguna.kontak.index') ? 'active' : '' }}"
                                            href="{{ route('pengguna.kontak.index') }}"><i
                                                class="fas fa-school me-1"></i>Informasi Sekolah</a></li>
                                    <li><a class="dropdown-item {{ Request::routeIs('pengguna.kontak.testimoni.store') ? 'active' : '' }}"
                                            href="{{ route('pengguna.kontak.testimoni.store') }}"><i
                                                class="fas fa-comment-dots me-1"></i>Beri Testimoni</a></li>
                                    <li><a class="dropdown-item {{ Request::routeIs('pengguna.saranmasukan.index') ? 'active' : '' }}"
                                            href="{{ route('pengguna.saranmasukan.index') }}"><i
                                                class="fas fa-lightbulb me-1"></i>Saran & Masukan</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
...
<script>
    ...
    dropdownToggles.forEach(toggle => {
            toggle.addEventListener("click", function (e) {
                ...
                document.querySelectorAll(".offcanvas-body .dropdown-menu").forEach(menu => {
                    if (menu !== submenu) {
