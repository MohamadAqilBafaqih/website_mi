                ...
                @if ($data && $data->jadwal)
                    <div class="card mb-4 border-0 shadow-lg animate-fade" data-delay="100">
                        <div class="card-header bg-navy text-white py-3 d-flex align-items-center">
                            ...
                            <h5 class="mb-0 fw-semibold">Rincian Jadwal</h5>
                        </div>
                ...
                @else
                    <div class="card mb-4 border-0 shadow-lg animate-fade" data-delay="100">
                        <div class="card-header bg-navy text-white py-3 d-flex align-items-center">
                            ...
                            <h5 class="mb-0 fw-semibold">Jadwal Pendaftaran</h5>
                        </div>
                        <div class="card-body p-5 text-center">
                            <div class="empty-state-icon mb-3">
                                <i class="fas fa-info-circle text-muted" style="font-size: 3rem;"></i>
                            </div>
                            <h5 class="text-navy mb-2">Belum ada informasi jadwal pendaftaran</h5>
                            <p class="text-muted mb-0" style="font-size: 1rem;">Informasi jadwal sedang dalam proses
                                pengumpulan</p>
                        </div>
                    </div>
                @endif
