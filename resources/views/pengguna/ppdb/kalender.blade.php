                    ...
                    <div class="card mb-4 border-0 shadow-lg animate-fade" data-delay="100">
                        ...
                        <div class="card-body p-4 text-center">
                            ...
                            @if ($data->kalender_akademik)
                                ...
                                <div class="mb-4">
                                    <a href="{{ asset('uploads/ppdb/' . $data->kalender_akademik) }}"
                                        class="btn btn-success px-4 py-2" download>
                            ...
                            @if (!$data->kalender_akademik && !$data->kalender)
                                <div class="p-5">
                                    ...
                                    <p class="text-muted mb-0" style="font-size: 1rem;">Informasi sedang dalam proses
                                        pengumpulan</p>
                                </div>
                            @endif
                        ...
                        <div class="card-footer bg-light text-muted text-end">
                            <small>Terakhir diperbarui:
                                {{ $data ? \Carbon\Carbon::parse($data->updated_at)->format('d F Y') : '-' }}</small>
                        </div>
                    </div>
                @else
                    <div class="card mb-4 border-0 shadow-lg animate-fade" data-delay="100">
